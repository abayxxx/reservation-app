                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('register.store') }}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="full_name" class="form-control" id="yourName" value="{{ old('full_name') }}" required>
                            </div>
                            ...
                            <div class="col-12">
                                <label for="passwordConfirmation" class="form-label">Password Konfirmasi</label>
